...
@register.inclusion_tag('pywims_exos/input_text_for_corrige.html', takes_context=True)
...
@register.inclusion_tag('pywims_exos/input_drag_for_corrige.html', takes_context=True)
